      ...
      (qt = new Map([
        ...
        (Ft = class {
          ...
          async createTemporaryTensor(t, n, r) {
            ...
            return (
              s ? s.push(i) : this.temporarySessionTensorIds.set(t, [i]), i
            );
          }
          uploadTensor(t, n) {
          ...
          registerMLConstant(t, n, r, o, i, s, a = !1) {
            ...
            return (
              j(
                "verbose",
                () =>
                  `[WebNN] registerMLConstant {dataType: ${
                    i.dataType
                  }, shape: ${i.shape}}} ${
                    a
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${
        ...
        ${
          h
            ? Zn(_, g, U, void 0, !d, I)
            : Qn(_, g, U, void 0, !d, I, !1, void 0, a)
        }`;
          };
          return {
            name: "Conv2DMatMul",
      ...
      (cl = (e) => {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${
          ...
          ${g.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
              ...
              let d2 = ${
                s ? B("coords", $.rank - 1, $.rank) : B("coords", 1, $.rank)
              };
              let xFRCCorner = vec3<u32>(${
                s ? B("coords", 1, $.rank) : B("coords", 2, $.rank)
              },
              ${s ? B("coords", 2, $.rank) : B("coords", 3, $.rank)},
              ${
                s ? B("coords", 3, $.rank) : B("coords", 4, $.rank)
              ...
              let xShapeY = ${
                s
                  ? B("uniforms.x_shape", 1, $.rank)
                  : B("uniforms.x_shape", 2, $.rank)
              };
              let xShapeZ = ${
                s
                  ? B("uniforms.x_shape", 2, $.rank)
                  : B("uniforms.x_shape", 3, $.rank)
              };
              let xShapeW = ${
                s
                  ? B("uniforms.x_shape", 3, $.rank)
                  : B("uniforms.x_shape", 4, $.rank)
              };
              let xShapeU = ${
                s
                  ? B("uniforms.x_shape", 4, $.rank)
    ...
    _s = E(() => {
      ...
      bs = (e, t, n) => {
        ...
        w_offset += 1u;`)
                  : l === 2
                  ? (H += `
          dotProd = dotProd + dot(vec4<${R}>(${D.getByOffset(
                      "x_offset"
                    )}, ${D.getByOffset(
                      "x_offset + 1u"
                    )}), vec4<${R}>(${G.getByOffset(
                      "w_offset"
                    )}, ${G.getByOffset("w_offset + 1u")}));
          x_offset += 2u;
          w_offset += 2u;`)
                  : l === 1 &&
                    (H += `
          dotProd = dotProd + dot(vec4<${R}>(${D.getByOffset(
                      ...
                      "w_offset"
                    )}, ${G.getByOffset("w_offset + 1u")}, ${G.getByOffset(
                      "w_offset + 2u"
                    )}, ${G.getByOffset("w_offset + 3u")}));
          x_offset += 4u;
          w_offset += 4u;`);
              else if (
                ((H += `
          ...
          dotProd = dotProd + xValue * wValue;`;
            ...
            _e = () => {
              ...
              if (l === 1) {
                ...
                for (let k = 0; k < f; k++)
                  H += `
            + ${D.getByOffset(`x_offset + ${k}`)} * ${G.getByOffset(
                    `w_offset + ${k}`
                  )}`;
                H += ";";
              } else if (l === 2) {
...
`)}
  ...
  var fc,
    ...
    xa = E(() => {
      ...
      (fc = (e, t) => {
        ...
        ${I.mainStart([g, 1, 1])}
          let output_indices = ${G.offsetToIndices(
            `(global_idx / ${g}) * ${b}`
          )};
          ...
          if (local_id.x < ${b}) {
            ...
            ${G.setByIndices(
              `${G.type.indices}(batch, row, col + local_id.x)`,
              "output_value"
            )};
          }
        }`;
        ...
        ${M.mainStart([y, b, 1])}
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var a_offset = local_idx; a_offset < ${_}; a_offset += ${h})
            {
              ...
              {
                sub_a[a_offset] = ${W.getByIndices(
                  `${W.type.indices}(batch, row, a_col)`
                )};
              } else {
            ...
            let b_data = ${O.getByIndices(
              `${O.type.indices}(b_row, block, 0)`
            )};
          ...
          if (local_idx < ${b}) {
            ...
            {
              ${U.setByIndices(
                `${U.type.indices}(batch, row, col + local_idx)`,
                "output_value"
              )}
            }
          }
    ...
    Ta = E(() => {
      ...
      (yc = (e) => {
        ...
        (bc = (e, t, n) => {
          ...
          for (let o = t - 1; o >= 0; --o)
            r += `
            k = i32(${e.indicesGet("indices", o)}) - ${B(
              "uniforms.pads",
              o,
              n
            )};
  ...
  var zc,
    ...
    data_offset += u32((u32(index) * element_count_dim));`),
        ...
        let value = updates[uniforms.num_updates_elements * ${
          n ? "global_idx" : "idx"
        } + i];
...
`),
    ...
    fn checkInputIndices(input_indices: ${e.type.indices}) -> bool {
      for (var i:u32 = 0; i < ${t.length}; i++) {
        ...
        if (input_index < 0 || input_index >= ${B(
  ...
  var Yc,
    ...
    du = E(() => {
      ...
      (Yc = (e, t) => {
        ...
        (ep = (e, t, n) => `fn calculateInputIndices(output_indices: ${
          t.type.indices
        }) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
